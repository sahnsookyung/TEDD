...
def test_render():
    ...
    # Phospholipase A2 isozyme CM-I, snake venom known to have anti-tumor properties
    ...
    # Amphetamine, used in the treatment of attention deficit hyperactivity disorder, narcolepsy, and obesity
